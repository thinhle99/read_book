...
declare type ID$1 = string;
declare type AnnotationCtorProps = {
    id?: ID$1 | null;
    name?: string | null;
    subject?: string | null;
...
declare type DocumentValidationStatusType = $Keys<typeof DocumentValidationStatus>;
...
declare type ISidebarMode = typeof SidebarMode[keyof typeof SidebarMode];
...
declare type CustomUISidebarConfiguration = Partial<{
...
declare type IsEditableCommentCallback = (comment: Comment) => boolean;

declare type IsAPStreamRenderedCallback = (annotation: Annotation) => boolean;
...
declare type AnnotationResizeStartCallback = (event: AnnotationsResizeEvent) => AnnotationResizeStartCallbackConfiguration;
...
declare type SigningServiceData = {
    signingToken: string;
};
...
declare type AnnotationsPasteEvent = {
    annotation: Annotation;
    formField?: FormField;
...
declare type IAnnotationToolbarType = 'stroke-color' | 'fill-color' | 'background-color' | 'opacity' | 'line-width' | 'blend-mode' | 'spacer' | 'delete' | 'annotation-note' | 'border-color' | 'border-width' | 'border-style' | 'color' | 'linecaps-dasharray' | 'line-style' | 'font' | 'overlay-text' | 'outline-color' | 'apply-redactions';
...
declare type AnnotationToolbarItemsCallback = (annotation: Annotation, options: {
...
declare type StoredSignaturesSetter = (annotations: List<InkAnnotation | ImageAnnotation>) => List<InkAnnotation | ImageAnnotation>;
declare type SearchStateSetter = (currentState: SearchState) => SearchState;
declare type AnnotationPresetsSetter = (currentState: Record<string, AnnotationPreset$1>) => Record<string, AnnotationPreset$1>;
...
declare type ServerConfiguration = SharedConfiguration & {
    documentId: string;
    authPayload: {
        jwt: string;
    };
...
declare type StandaloneConfiguration = SharedConfiguration & {
...
declare type Configuration = ServerConfiguration | StandaloneConfiguration;
...
declare type AnnotationPreset = AnnotationPreset$1;
declare type AnnotationPresetID = AnnotationPresetID$1;
